...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='apartment',
            name='state',
            field=enumfields.fields.EnumField(default='free', enum=hitas.models.apartment.ApartmentState, max_length=10, null=True),
        ),
        migrations.AlterField(
            model_name='apartment',
            name='surface_area',
            field=hitas.models._base.HitasModelDecimalField(decimal_places=2, help_text='Measured in m^2', max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))]),
        ),
    ]
