    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    enumfields.fields.EnumField(
                        default="free", enum=hitas.models.apartment.ApartmentState, max_length=10
                    ),
                ),
                (
                    "surface_area",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "postal_code",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="real_estates", to="hitas.postalcode"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="property_managers",
                        to="hitas.postalcode",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "postal_code",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="persons", to="hitas.postalcode"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "apartment",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="owners", to="hitas.apartment"
                    ),
                ),
                (
                    "person",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="owners", to="hitas.person"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="housing_companies", to="hitas.postalcode"
            ),
        ),
        migrations.AddField(
            model_name="housingcompany",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "postal_code",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="buildings", to="hitas.postalcode"
                    ),
                ),
                (
                    "real_estate",
        ...
        migrations.AddField(
            ...
            name="apartment_type",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="apartments", to="hitas.apartmenttype"
            ),
        ),
        migrations.AddField(
            model_name="apartment",
        ...
        migrations.AddField(
            ...
            name="postal_code",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="apartments", to="hitas.postalcode"
            ),
        ),
        ...
        migrations.AddConstraint(
            model_name="housingcompany",
            constraint=models.CheckConstraint(
                check=models.Q(("realized_acquisition_price__gte", 0)), name="realized_acquisition_price_positive"
            ),
        ),
    ]
