    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_area', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(4), django.core.validators.MinValueValidator(1)])),
            ],
            options={
        ...
        migrations.AlterField(
            ...
            name='postal_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='apartments', to='hitas.hitaspostalcode'),
        ),
        migrations.AlterField(
            model_name='building',
            name='postal_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='buildings', to='hitas.hitaspostalcode'),
        ),
        migrations.AlterField(
            model_name='housingcompany',
            name='postal_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='housing_companies', to='hitas.hitaspostalcode'),
        ),
        migrations.AlterField(
            model_name='realestate',
            name='postal_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='real_estates', to='hitas.hitaspostalcode'),
        ),
