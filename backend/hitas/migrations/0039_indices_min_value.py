...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='value',
            field=hitas.models._base.HitasModelDecimalField(decimal_places=2, max_digits=15, validators=[django.core.validators.MinValueValidator(1)]),
        ),
        migrations.AlterField(
        ...
        migrations.AddConstraint(
            model_name='constructionpriceindex',
            constraint=models.CheckConstraint(check=models.Q(('value__gt', 0)),
                                              name='construction_price_index_value_positive'),
        ),
        migrations.AddConstraint(
            model_name='constructionpriceindex2005equal100',
            constraint=models.CheckConstraint(check=models.Q(('value__gt', 0)),
                                              name='construction_price_2005_index_value_positive'),
        ),
        migrations.AddConstraint(
            model_name='marketpriceindex',
            constraint=models.CheckConstraint(check=models.Q(('value__gt', 0)),
                                              name='market_price_index_value_positive'),
        ),
        migrations.AddConstraint(
            model_name='marketpriceindex2005equal100',
            constraint=models.CheckConstraint(check=models.Q(('value__gt', 0)),
                                              name='market_price_2005_index_value_positive'),
        ),
        migrations.AddConstraint(
            model_name='maximumpriceindex',
            constraint=models.CheckConstraint(check=models.Q(('value__gt', 0)),
                                              name='maximum_price_index_value_positive'),
        ),
    ]
