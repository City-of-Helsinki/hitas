...
from hitas.oracle_migration.types import (
    ...
    HitasAnonymizedCompany,
    HitasAnonymizedEmail,
    HitasBoolean,
)
...
property_managers = Table(
    ...
    Column("C_TOIMISTO", HitasAnonymizedCompany(100), key="name", nullable=False),
    ...
    Column("C_EMAIL", HitasAnonymizedEmail(50), key="email"),
