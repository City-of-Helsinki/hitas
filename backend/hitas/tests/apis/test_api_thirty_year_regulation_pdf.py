...
def test__api__regulation__continuation_letter(api_client: HitasAPIClient, freezer):
    ...
    url = (
        reverse("hitas:thirty-year-regulation-continuation-letter")
    ...
    assert page_1 == cleandoc(
        ...
        {sale.apartment.housing_company.property_manager.name}
        PL 169
        {row.postal_code} {sale.apartment.housing_company.postal_code.city.upper()}
...
@pytest.mark.django_db
def test__api__regulation__continuation_letter__no_regulation_data(api_client: HitasAPIClient, freezer):
    day = datetime.datetime(2023, 2, 1)
    freezer.move_to(day)
...
@pytest.mark.django_db
def test__api__regulation__continuation_letter__invalid_id(api_client: HitasAPIClient, freezer):
    url = reverse("hitas:thirty-year-regulation-continuation-letter") + "?housing_company_id=foo"
...
@pytest.mark.django_db
def test__api__regulation__continuation_letter__id_missing(api_client: HitasAPIClient, freezer):
    url = reverse("hitas:thirty-year-regulation-continuation-letter")
