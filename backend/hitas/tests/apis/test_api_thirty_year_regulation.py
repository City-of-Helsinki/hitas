        ...
        released_from_regulation=[
            ComparisonData(
                ...
                property_manager=PropertyManagerInfo(
                    ...
                    address=AddressInfo(
                        street_address=sale_old.apartment.housing_company.property_manager.street_address,
                        postal_code=sale_old.apartment.housing_company.property_manager.postal_code,
                        city=sale_old.apartment.housing_company.property_manager.city,
                    ),
                    last_modified=this_month.isoformat(),
                ),
                letter_fetched=False,
